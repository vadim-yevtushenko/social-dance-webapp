...
const NotificationComponent = ({showNotification, isError, message}) => {
    ...
    return (
        <>
            ...
            <div
                aria-live="assertive"
                className="pointer-events-none fixed inset-0 flex items-end px-4 py-6 sm:items-start sm:p-6 mt-12 sm:mt-0"
            >
                            ...
                            <div className="p-4">
                                <div className="flex items-start">
                                    <div className="flex-shrink-0">
                                        {isError ? <ExclamationTriangleIcon className="h-10 w-10 text-red-600" aria-hidden="true" />
